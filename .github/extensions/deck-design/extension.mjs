...
const session = await joinSession({
  tools: [
    {
      name: "nice_deck_edit",
      description: "Open a local, source-preserving text editor for an existing trusted HTML deck. Use a separate copy for experiments. Returns an authorized loopback URL for Browser Canvas; never share that launch URL. Edits are drafts, not presentation approval.",
      parameters: {
        type: "object",
        properties: {
          htmlPath: {
          ...
          return {
            textResultForLlm: JSON.stringify({
              ...
              next: [
                ...
                "Native text includes table cells, prices, notes, citation labels, supporting slides and source SVG labels. Formatted fragments use the Text panel; markup and link destinations are preserved.",
                "Image-baked text, generated chart internals, embedded applications and explicitly locked regions are not rewritten.",
                "Save writes bounded text patches to this source, never to a preview snapshot.",
